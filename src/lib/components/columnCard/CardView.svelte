	...
	{#if card}
		...
		<div class="space-y-2">
			...
			<div class="flex items-center gap-3 py-2">
				<span>
					<span class="text-sm font-semibold text-gray-800">Due Date:</span>
					{#if isEdit}
						<input />
					{:else}
				...
				<button class="flex items-center gap-1 text-yellow-600"
					><span class="text-sm font-semibold">Edit</span>
					<Icon icon="iconoir:edit" width="16" height="16" class="text-yellow-600" /></button
				>
